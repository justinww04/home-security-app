...
-add account creation and login page --complete -adding 2fa --currently adding sms verification for the 2 factor authentification.
...
-fixing sudden errors - currently work in progress/ still work in progress
