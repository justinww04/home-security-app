...
- worked on hand tracking- working on adding an ui for the app for the hand tracking aspect new ui is complete so I can switch on and off hand tracking and non hand tracking mode
- changed ui colors - re worked ui layout finished 
